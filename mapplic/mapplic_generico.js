	...
	var Mapplic = function() {
		...
		function Tooltip() {
			...
			this.init = function() {
				...
				this.aumentarTexto = $('<div></div>').addClass('mapplic-tooltip-aumentar-texto').addClass('boton-opciones-location').appendTo(this.el2);
				this.aumentarTexto.on('click', function() {
					s.aumentarTextoF();
				});
				this.disminuirTexto = $('<div></div>').addClass('mapplic-tooltip-disminuir-texto').addClass('boton-opciones-location').appendTo(this.el2);
				this.disminuirTexto.on('click', function() {
					s.disminuirTextoF();
				});
			...
			this.set = function(location) {
				if (location) {
					...
					if(location.video) this.video.show();
			...
			this.aumentarTextoF = function() {
				this.tamanoTexto += 2;
				this.desc.children().css('font-size', this.tamanoTexto + 'px');
			}

			this.disminuirTextoF = function() {
				if (this.tamanoTexto > 13) {
					this.tamanoTexto -= 2;
					this.desc.children().css('font-size', this.tamanoTexto + 'px');
				}
			}
		...
		function Sidebar() {
			...
			this.addLocation = function(data) {
				if(data.show == "true"){
					...
					$('<h4></h4>').text(data.title).css('text-transform', 'uppercase').appendTo(link)
