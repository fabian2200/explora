...
function mostrarBanderas() {
    if(numeroPregunta < 10) {
        ...
        guardar_resultado("Pinta la bandera", respondidas_correctas, contador_juego, "Normal", "Categoría Única");
...
function seleccionarBandaAdivinar(bandera, div) {
    ...
    if(respondidas_correctas_adivina + respondidas_incorrectas_adivina == 10) {
        ...
        clearInterval(intervalo_contador_juego);
        guardar_resultado("Adivina la bandera", respondidas_correctas_adivina, contador_juego, "Normal", "Categoría Única");
